...
import TenisRed from '../../assets/tenisRedAir.png'
    ...
    <div>
      ...
      <div className=' bg-zinc-900 flex justify-center items-center w-full h-screen p-3 font-poppins text-start'>
        <div className='bg-white h-[540px] w-full max-w-4xl shadow-xl flex flex-col items-center justify-center md:flex-row'>
          ...
          <div className='w-full h-full md:w-1/2 flex items-center justify-center bg-bgRedTenis bg-cover bg-no-repeat bg-center'>
              <img src={TenisRed} alt="Tenis Nike Air" className='max-w-lg w-11/12 md:w-full object-cover z-30 duration-300 hover:-rotate-6 hover:scale-110 md:hover:scale-125' />
          </div>
        </div>
      </div>
    </section>
