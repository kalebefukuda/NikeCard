  ...
  return (
    <div className="App">
      <section className='w-full h-full overflow-hidden '>
        ...
        <div className=' bg-slate-300 flex justify-center items-center w-full h-screen p-3 font-poppins text-start'>
            ...
            <div className='w-full h-full md:w-1/2 flex items-center justify-center flex-col' >
                ...
                <div className='w-full h-full flex items-center justify-center' >
                    <div  className='mb-2'>
                      ...
                      <a href="#" className='font-bold bg-zinc-800 text-white py-2 px-5 border-2 border-zinc-800 duration-200 hover:bg-white hover:text-zinc-800' > QUERO CONHECER!</a>
                    </div>
                </div>
            </div>

            <div className='w-full h-full md:w-1/2 flex items-center justify-center bg-bg_tenis bg-cover bg-no-repeat bg-center'>
